...
def get_booking(flight_period: list[int]) -> bool:
    ...
    # return False
    if start == end and start % 7 != 0: return False

    if (start % 7 == 0) or (start % 7 >= end % 7): return True
    return False
...
class BookingTest(unittest.TestCase):
    ...
    def test_1(self):
        ...
        self.assertFalse(get_booking([7, 2]))  # dzień wylotu musi być przed dniem powrotu
